...
//
// Fora do broadcast: `sessions` (login/logout não é dado de tela) e `form_events`
// (telemetria de drop-off dos forms públicos — alta frequência, recarregaria o
// cockpit de todo mundo a cada pageview de form).
const SILENT = new Set(["sessions", "form_events"]);
