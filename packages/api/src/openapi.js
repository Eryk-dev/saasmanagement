...
const SUPPORT_PATHS = {
  ...
  "/api/tickets/{id}/linear": { parameters: [idParam()],
    ...
    post: { tags: ["Suporte"], summary: "Manda o ticket pro Linear agora (cria a issue se ainda não existe) ou vincula a uma issue existente com `issue` (ENG-123, URL ou uuid)", security: SEC, requestBody: json({ type: "object", properties: { issue: { type: "string" } } }), responses: { 200: { description: "Ticket" }, 404: { description: "Issue não encontrada" }, 424: { description: "Linear não configurado ou fora do ar" } } },
    delete: { tags: ["Suporte"], summary: "Desvincula o ticket da issue (a issue continua no Linear; o cockpit nunca apaga issue)", security: SEC, responses: { 200: { description: "Ticket" } } } },
