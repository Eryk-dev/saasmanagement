    ...
    <div>
      ...
      <div className="tbl-x" style={{ border: "1px solid var(--line-1)", borderRadius: "var(--r-4)", background: "var(--bg-1)", boxShadow: "var(--shadow-card)" }}>
       <div style={{ minWidth: 860 }}>
        <div className="kicker" style={{ display: "grid", gridTemplateColumns: `1fr repeat(${ROLE_OPTS.length}, 92px) 96px 140px 120px 82px`, gap: 8, padding: "10px 14px", background: "var(--bg-inset)", borderBottom: "1px solid var(--line-1)" }}>
          <span>Usuário</span>
        ...
        {Array.isArray(users) && users.map((u) => (
          <div key={u.id} style={{ display: "grid", gridTemplateColumns: `1fr repeat(${ROLE_OPTS.length}, 92px) 96px 140px 120px 82px`, gap: 8, padding: "9px 14px", borderBottom: "1px solid var(--line-1)", alignItems: "center", opacity: saving === u.id ? 0.6 : 1 }}>
      ...
      <div style={{ padding: "14px 16px", border: mpOn ? "1px solid var(--line-1)" : "1px dashed var(--line-2)", borderRadius: "var(--r-3)", background: "var(--bg-1)", marginBottom: 10 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
          <div>
            ...
            <div className="mono dim" style={{ fontSize: 11, marginTop: 3 }}>
              financeiro: espelho de quem pagou e como (tela Financeiro, aba Pagamentos) + cobrança avulsa com link + assinaturas recorrentes da conta pra ligar aos clientes (Clientes → Assinaturas → MP recorrentes) + baixa automática de fatura
            </div>
          </div>
