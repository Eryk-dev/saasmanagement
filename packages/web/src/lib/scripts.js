...
export const DEFAULT_SCRIPTS = {
  ...
  call: {
    ...
    passos: [
      { t: "Raio-X da operação (5 min) · SPIN Situação", fala: "Me conta como está a operação hoje: são {{contas}} e uns {{anuncios}} anúncios, certo? Quem sobe anúncio hoje? E quanto vocês estão faturando por mês?", dica: "Situação do SPIN: confirmar, não redescobrir (o form já respondeu). Dados do SDR nos campos ao lado: time {{equipe}}, expansão {{expansao}}. Complete o que faltar, cada lacuna é pergunta." },
      { t: "Pergunta da suspensão (define a narrativa) · SPIN Problema", fala: "E você já teve conta suspensa ou derrubada no Mercado Livre? Como foi?", dica: "A dor do anúncio no card já dá a pista (código B = conta banida); confirme na conversa. Metade dos leads chega machucado e esse é o gatilho mais forte. Se sim, a call vira PROTEÇÃO (blindar a operação: qualquer conta nova recebe tudo em minutos). Se não, vira CRESCIMENTO (multiplicar presença no catálogo)." },
      { t: "Aprofundar a dor · SPIN Problema → Implicação", fala: "E o que isso já te custou? Quanto tempo do teu time vai embora nisso por semana? E enquanto o produto não está nas outras contas, quantas vendas ficam na mesa?", dica: "Faça o lead pôr NÚMERO na dor (dor quantificada é o que fecha) usando a dupla da dor do card: [A] braço: quanto tempo por semana só copiando anúncio? quantas vendas as outras contas perdem enquanto isso? · [B] banida: quanto tempo levou pra reerguer? se a principal cair amanhã, quanto perde por dia? · [C] SKUs: com que frequência acha anúncio desatualizado? quanto custa um preço errado até alguém perceber? · [D] folha: quanto da rotina do time é repetição? dobrar de contas seriam quantas contratações? · [E] exposição: o que impede o catálogo completo em mais contas? quanto fica na mesa com o concorrente aparecendo três vezes na busca?" },
      { t: "Espelho da dor (2 min) · SPIN Necessidade", fala: "Deixa eu ver se entendi: hoje o gargalo é braço. Subir esses {{anuncios}} anúncios em outra conta, na mão, levaria meses, é isso? E se isso rodasse sozinho, o que você faria primeiro: mais contas ou mais produto?", dica: "Devolver a dor nas palavras do lead antes da tese; a resposta do 'o que você faria' é a Necessidade declarada, o gancho da demo (guarde e reuse no fechamento). As duas dores que dominam: falta de braço (quase todas as calls) e medo de perder conta (metade)." },
