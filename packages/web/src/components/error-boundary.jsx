...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    const card = (
      <div role="alert" style={{ border: "1px solid var(--line-1)", borderRadius: "var(--r-3)", background: "var(--bg-1)", padding: "20px 22px", maxWidth: 440, textAlign: "center", boxShadow: "0 10px 34px rgba(0,0,0,0.20)" }}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center" }}>
          ...
          <button type="button" onClick={() => location.reload()} style={{ height: 30, padding: "0 14px", borderRadius: "var(--r-2)", border: "1px solid var(--line-1)", background: "var(--bg-2)", color: "var(--fg-2)", fontSize: 12.5 }}>
            Recarregar
          </button>
        </div>
      </div>
