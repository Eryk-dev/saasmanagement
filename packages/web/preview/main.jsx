...
import {metasReview,setupMetasReview} from "./metas-review-mock.js";
...
import {analiseReview,setupAnaliseReview} from "./analise-review-mock.js";
import {blogReview,setupBlogReview} from "./blog-review-mock.js";
import {disparosReview,setupDisparosReview} from "./disparos-review-mock.js";
import {formsReview,setupFormsReview} from "./forms-review-mock.js";
import {metricsReview,setupMetricsReview} from "./metrics-review-mock.js";
...
import { offersReview, setupOffersReview } from "./offers-review-mock.js";
import { proposalsReview, setupProposalsReview } from "./proposals-review-mock.js";
...
if (customersReview) setupCustomersReview(window.SEED);
if (proposalsReview) setupProposalsReview(window.SEED);
if (offersReview) setupOffersReview(window.SEED);
...
if (metricsReview) setupMetricsReview(window.SEED);
if (formsReview) setupFormsReview(window.SEED);
if (disparosReview) setupDisparosReview(window.SEED);
if (blogReview) setupBlogReview(window.SEED);
...
if (settingsReview) setupSettingsReview(window.SEED);
if (expensesReview) setupExpensesReview(window.SEED);
if (remuneracaoReview) setupRemuneracaoReview(window.SEED);
if (metasReview) setupMetasReview(window.SEED);
...
function PreviewTheme({ children }) {
  React.useEffect(() => {
    if (params.has("review") || marketingPreview || params.has("inbox") || params.has("team") || params.has("finance") || params.has("splash")) {
